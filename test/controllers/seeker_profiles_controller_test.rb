...
class SeekerProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seeker_profile" do
    assert_difference('SeekerProfile.count') do
      post seeker_profiles_url, params: { seeker_profile: { currency: @seeker_profile.currency, current_salary: @seeker_profile.current_salary, first_name: @seeker_profile.first_name, is_annually_monthly: @seeker_profile.is_annually_monthly, last_name: @seeker_profile.last_name } }
    end
  ...
  test "should update seeker_profile" do
    patch seeker_profile_url(@seeker_profile), params: { seeker_profile: { currency: @seeker_profile.currency, current_salary: @seeker_profile.current_salary, first_name: @seeker_profile.first_name, is_annually_monthly: @seeker_profile.is_annually_monthly, last_name: @seeker_profile.last_name } }
