...
class BusinessStreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business_stream" do
    assert_difference('BusinessStream.count') do
      post business_streams_url, params: { business_stream: { business_stream_name: @business_stream.business_stream_name } }
    end
  ...
  test "should update business_stream" do
    patch business_stream_url(@business_stream), params: { business_stream: { business_stream_name: @business_stream.business_stream_name } }
