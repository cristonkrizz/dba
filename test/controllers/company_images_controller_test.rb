...
class CompanyImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create company_image" do
    assert_difference('CompanyImage.count') do
      post company_images_url, params: { company_image: { company_id: @company_image.company_id, company_image: @company_image.company_image } }
    end
  ...
  test "should update company_image" do
    patch company_image_url(@company_image), params: { company_image: { company_id: @company_image.company_id, company_image: @company_image.company_image } }
