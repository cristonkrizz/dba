...
class UserLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_log" do
    assert_difference('UserLog.count') do
      post user_logs_url, params: { user_log: { last_job_apply_date: @user_log.last_job_apply_date, last_login_date: @user_log.last_login_date } }
    end
  ...
  test "should update user_log" do
    patch user_log_url(@user_log), params: { user_log: { last_job_apply_date: @user_log.last_job_apply_date, last_login_date: @user_log.last_login_date } }
