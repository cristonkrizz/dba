...
class UserTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_type" do
    assert_difference('UserType.count') do
      post user_types_url, params: { user_type: { user_type_name: @user_type.user_type_name } }
    end
  ...
  test "should update user_type" do
    patch user_type_url(@user_type), params: { user_type: { user_type_name: @user_type.user_type_name } }
