class UserAccountsController < ApplicationController
  ...
  private
    ...
    def user_account_params
      params.require(:user_account).permit(:user_type_id, :email, :password, :date_of_birth, :gender, :is_active, :contact_number, :sms_notification_active, :email_notification_active, :user_image, :registration_date)
    end
end
